 ...
 *      +------+-------------------------+----------------+--------------------+
 *        1bit           30bits                10bits               23bit
 *    SnowflakeSpec(
 *      timeBits=30,
 *      timeEpoch=2019-02-04T00:00:00Z,
 *      epochSecond=1549238400,
 *      validityPeriod=2053-02-12T13:37:03Z,
 *      workerBits=10,
 *      totalWorkerNumber=1024,
 *      sequenceNumberPerSecond=8388608)
 */
class Snowflake(
    private val timeBits: Int = 30,
    private val workerBits: Int = 10,
    private val timeEpoch: String = "2019-02-04T00:00:00Z"
) {
